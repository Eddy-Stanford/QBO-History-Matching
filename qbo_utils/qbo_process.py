...
def get_signal_period_amplitude(signal:np.ndarray,smoothed_avg_months=5,points_per_month=1):
    smoothed_signal = rolling_average(signal,n_months=smoothed_avg_months,points_per_month=points_per_month)
